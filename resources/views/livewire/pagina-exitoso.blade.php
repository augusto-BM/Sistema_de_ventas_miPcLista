                        ...
                        <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                            <div class="flex flex-col items-start justify-start space-y-2">
                                <p class="text-lg font-semibold leading-4 text-left text-gray-800 dark:text-gray-400">
                                    {{ $pedido->direccion->nombre }}</p>
                                <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                                    {{ $pedido->direccion->direccion }}</p>
                                <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                                    {{ $pedido->direccion->ciudad }},
                                    {{ $pedido->direccion->estado }}</p>
                                <p class="text-sm leading-4 cursor-pointer dark:text-gray-400">Telefono:
                                    {{ $pedido->direccion->celular }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        ...
                        <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
                            {{ Number::currency($pedido->total_pagar, 'PEN') }}</p>
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            Metodo de Pago: </p>
                        <p class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400 ">
                            {{ $pedido->metodo_pago == 'pagoContraEntrega' ? 'Pago contra entrega' : 'Tarjeta' }}</p>
                    </div>
                </div>
                <div class="px-4 mb-10">
                    <div
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-400">Detalles del pedido
                            </h2>
                            <div
                                ...
                                <div class="flex items-center justify-between w-full">
                                    ...
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">
                                        {{ Number::currency(0, 'PEN') }}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Envio</p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{ Number::currency(0, 'PEN') }}</p>
                                </div>
                            </div>
                            <div class="flex items-center justify-between w-full">
                        ...
                        <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
                            <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-400">Envios</h2>
                                ...
                                <div class="flex items-center justify-center space-x-2">
                                    ...
                                    <div class="flex flex-col items-center justify-start">
                                        <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                                            Delivery<br><span class="text-sm font-normal">Entrega en 24 Horas</span>
                                        </p>
                                    </div>
                                </div>
                                <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">{{ Number::currency(0, 'PEN') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
