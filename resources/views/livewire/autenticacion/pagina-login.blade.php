        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <div class="p-4 sm:p-7">
            <div class="text-center">
              <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Iniciar Sesion</h1>
              <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Aun no tienes una cuenta?
                <a wire:navigate class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/registrar">
                  Crear cuenta aqui
                </a>
              </p>
            </div>
            ...
            <form>
              <div class="grid gap-y-4">
                <!-- Form Group -->
                <div>
                  <label for="email" class="block text-sm mb-2 dark:text-white">Correo electronico</label>
                  <div class="relative">
                ...
                <div>
                  <div class="flex justify-between items-center">
                    ...
                    <a wire:navigate class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/olvidar">Olvidaste tu contraseña?</a>
                  </div>
                  <div class="relative">
                  ...
                  <p class="hidden text-xs text-red-600 mt-2" id="password-error">8+ caracteres requerido</p>
                </div>
                <!-- End Form Group -->
