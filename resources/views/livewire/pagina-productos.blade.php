                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $producto->id }}">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        ...
                                        <a wire:click.prevent='agregarAlCarrito({{ $producto->id }})' href="#"
                                            ...
                                            </svg><span wire:loading.remove wire:target='agregarAlCarrito({{ $producto->id }})'>Añadir al carrito</span><span wire:loading wire:target='agregarAlCarrito({{ $producto->id }})'>Añadiendo...</span>
                                        </a>
