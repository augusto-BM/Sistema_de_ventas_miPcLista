<div>
    {{-- EMPIEZA SECCION BANNER --}}
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-red-300 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Bienvenidos a <br> <span class="text-blue-600">Mi Pc Lista</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Compra una amplia variedad de productos electrónicos.
                        productos como Computadoras, Laptops, Smartwatches, Televisión y muchos más.</p>
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-3xl border-4 border-transparent bg-white shadow-lg transform transition-transform hover:scale-105 hover:rotate-2 hover:shadow-2xl opacity-80"
    ...
    {{-- EMPIEZA SECCION MARCAS  --}}
    <section class="py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-4xl font-bold dark:text-gray-200"> Explorar Populares<span class="text-blue-500">
                            Marcas
                        </span> </h1>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Descubre las marcas líderes en electrónica que ofrecen tecnología innovadora y soluciones
                    para todos. Desde computadoras hasta accesorios, estas marcas están diseñadas para
                    mejorar tu experiencia diaria.
                </p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                ...
                @foreach ($marcas as $marca)
                    <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $marca->id }}">
                        <a wire:navigate href="/productos?marcas_seleccionadas[0]={{ $marca->id}}" class="">
    ...
    {{-- EMPIEZA SECCION CATEGORIAS  --}}
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200"> Explorar <span class="text-blue-500"> Categorias
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                        </div>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Descubre las mejores categorías de aparatos electrónicos , cada categoría ofrece innovaciones que mejoran tu vida diaria. No te pierdas las últimas tendencias en tecnología y elige los dispositivos que se adapten a tus necesidades.
                </p>
            </div>
        </div>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                <a wire:navigate class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="/productos?categorias_seleccionadas[0]={{ $categoria->id}}" wire:key="{{ $categoria->id }}">
                    <div class="p-4 md:p-5">
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">
                                <img class="h-[2.375rem] w-[2.375rem] rounded-full"
                                    src="{{ url('storage/' . $categoria->imagen) }}"
    ...
    {{-- TERMINA SECCION CATEGORIAS --}}

    {{-- EMPIEZA SECCION CLIENTES COMENTARIOS  --}}
    <section class="py-14 font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            <div class="max-w-xl mx-auto">
                <div class="text-center ">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold dark:text-gray-200"> Comentarios <span class="text-blue-500">
                                de Clientes
                            </span> </h1>
                        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                            <div class="flex-1 h-2 bg-blue-200">
                    ...
                    <p class="mb-12 text-base text-center text-gray-500">
                        Lee lo que nuestros clientes dicen sobre sus experiencias. Sus comentarios son una valiosa fuente de información que te ayudará a tomar la mejor decisión al elegir tus productos electrónicos. ¡Descubre opiniones reales y testimonios!
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    ...
                    <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                        "¡Excelente producto! La calidad es impresionante y funciona a la perfección. Totalmente recomendable."
                    </p>
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    ...
                    <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                        "La atención al cliente fue excepcional. Me ayudaron con todas mis dudas y el envío fue rápido."
                    </p>
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            <ul class="flex items-center justify-start mr-4">
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    ...
                    <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                        "Muy satisfecho con mi compra. El aparato supera mis expectativas y tiene un gran rendimiento."
                    </p>
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            <ul class="flex items-center justify-start mr-4">
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    ...
                    <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                        "Sin duda, una de las mejores decisiones que he tomado. ¡No puedo imaginar mi día a día sin este dispositivo!"
                    </p>
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            <ul class="flex items-center justify-start mr-4">
    ...
    {{-- TERMINA SECCION CLIENTES COMENTARIOS --}}
</div>
