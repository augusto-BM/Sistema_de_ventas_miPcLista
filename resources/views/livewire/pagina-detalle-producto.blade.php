                    ...
                    <div class="lg:pl-20">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click='agregarAlCarrito({{ $producto->id }})'
                                class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700"><span
                                    wire:loading.remove wire:target='agregarAlCarrito({{ $producto->id }})'>Añadir al
